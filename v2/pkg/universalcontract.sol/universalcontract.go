...
func (_UniversalContract *UniversalContractTransactor) OnRevert(opts *bind.TransactOpts, context ZContext, zrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
...
//
// Solidity: function onRevert((bytes,address,uint256) context, address zrc20, uint256 amount, bytes message) returns()
func (_UniversalContract *UniversalContractSession) OnRevert(context ZContext, zrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
...
//
// Solidity: function onRevert((bytes,address,uint256) context, address zrc20, uint256 amount, bytes message) returns()
func (_UniversalContract *UniversalContractTransactorSession) OnRevert(context ZContext, zrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _UniversalContract.Contract.OnRevert(&_UniversalContract.TransactOpts, context, zrc20, amount, message)
}
