...
func (_IGatewayZEVM *IGatewayZEVMTransactor) Withdraw(opts *bind.TransactOpts, amount *big.Int, chainId *big.Int) (*types.Transaction, error) {
	return _IGatewayZEVM.contract.Transact(opts, "withdraw", amount, chainId)
}

// Withdraw is a paid mutator transaction binding the contract method 0x441a3e70.
//
// Solidity: function withdraw(uint256 amount, uint256 chainId) returns()
func (_IGatewayZEVM *IGatewayZEVMSession) Withdraw(amount *big.Int, chainId *big.Int) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.Withdraw(&_IGatewayZEVM.TransactOpts, amount, chainId)
}

// Withdraw is a paid mutator transaction binding the contract method 0x441a3e70.
//
// Solidity: function withdraw(uint256 amount, uint256 chainId) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactorSession) Withdraw(amount *big.Int, chainId *big.Int) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.Withdraw(&_IGatewayZEVM.TransactOpts, amount, chainId)
}

// Withdraw0 is a paid mutator transaction binding the contract method 0x4c674934.
//
// Solidity: function withdraw(bytes receiver, uint256 chainId, uint256 amount, address zrc20) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactor) Withdraw0(opts *bind.TransactOpts, receiver []byte, chainId *big.Int, amount *big.Int, zrc20 common.Address) (*types.Transaction, error) {
	return _IGatewayZEVM.contract.Transact(opts, "withdraw0", receiver, chainId, amount, zrc20)
}

// Withdraw0 is a paid mutator transaction binding the contract method 0x4c674934.
//
// Solidity: function withdraw(bytes receiver, uint256 chainId, uint256 amount, address zrc20) returns()
func (_IGatewayZEVM *IGatewayZEVMSession) Withdraw0(receiver []byte, chainId *big.Int, amount *big.Int, zrc20 common.Address) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.Withdraw0(&_IGatewayZEVM.TransactOpts, receiver, chainId, amount, zrc20)
}

// Withdraw0 is a paid mutator transaction binding the contract method 0x4c674934.
//
// Solidity: function withdraw(bytes receiver, uint256 chainId, uint256 amount, address zrc20) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactorSession) Withdraw0(receiver []byte, chainId *big.Int, amount *big.Int, zrc20 common.Address) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.Withdraw0(&_IGatewayZEVM.TransactOpts, receiver, chainId, amount, zrc20)
}

// WithdrawAndCall is a paid mutator transaction binding the contract method 0x562aef2d.
//
// Solidity: function withdrawAndCall(bytes receiver, uint256 chainId, uint256 amount, address zrc20, bytes message) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactor) WithdrawAndCall(opts *bind.TransactOpts, receiver []byte, chainId *big.Int, amount *big.Int, zrc20 common.Address, message []byte) (*types.Transaction, error) {
	return _IGatewayZEVM.contract.Transact(opts, "withdrawAndCall", receiver, chainId, amount, zrc20, message)
}

// WithdrawAndCall is a paid mutator transaction binding the contract method 0x562aef2d.
//
// Solidity: function withdrawAndCall(bytes receiver, uint256 chainId, uint256 amount, address zrc20, bytes message) returns()
func (_IGatewayZEVM *IGatewayZEVMSession) WithdrawAndCall(receiver []byte, chainId *big.Int, amount *big.Int, zrc20 common.Address, message []byte) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.WithdrawAndCall(&_IGatewayZEVM.TransactOpts, receiver, chainId, amount, zrc20, message)
}

// WithdrawAndCall is a paid mutator transaction binding the contract method 0x562aef2d.
//
// Solidity: function withdrawAndCall(bytes receiver, uint256 chainId, uint256 amount, address zrc20, bytes message) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactorSession) WithdrawAndCall(receiver []byte, chainId *big.Int, amount *big.Int, zrc20 common.Address, message []byte) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.WithdrawAndCall(&_IGatewayZEVM.TransactOpts, receiver, chainId, amount, zrc20, message)
}
...
func (_IGatewayZEVM *IGatewayZEVMTransactor) WithdrawAndCall0(opts *bind.TransactOpts, amount *big.Int, chainId *big.Int, message []byte) (*types.Transaction, error) {
	return _IGatewayZEVM.contract.Transact(opts, "withdrawAndCall0", amount, chainId, message)
}

// WithdrawAndCall0 is a paid mutator transaction binding the contract method 0x80bd3d03.
//
// Solidity: function withdrawAndCall(uint256 amount, uint256 chainId, bytes message) returns()
func (_IGatewayZEVM *IGatewayZEVMSession) WithdrawAndCall0(amount *big.Int, chainId *big.Int, message []byte) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.WithdrawAndCall0(&_IGatewayZEVM.TransactOpts, amount, chainId, message)
}

// WithdrawAndCall0 is a paid mutator transaction binding the contract method 0x80bd3d03.
//
// Solidity: function withdrawAndCall(uint256 amount, uint256 chainId, bytes message) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactorSession) WithdrawAndCall0(amount *big.Int, chainId *big.Int, message []byte) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.WithdrawAndCall0(&_IGatewayZEVM.TransactOpts, amount, chainId, message)
}
