...
func (_IGatewayZEVM *IGatewayZEVMTransactor) DepositAndRevert(opts *bind.TransactOpts, zrc20 common.Address, amount *big.Int, target common.Address, message []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayZEVM.contract.Transact(opts, "depositAndRevert", zrc20, amount, target, message, revertContext)
}

// DepositAndRevert is a paid mutator transaction binding the contract method 0x1cf34dcd.
//
// Solidity: function depositAndRevert(address zrc20, uint256 amount, address target, bytes message, (address,uint64,bytes) revertContext) returns()
func (_IGatewayZEVM *IGatewayZEVMSession) DepositAndRevert(zrc20 common.Address, amount *big.Int, target common.Address, message []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.DepositAndRevert(&_IGatewayZEVM.TransactOpts, zrc20, amount, target, message, revertContext)
}

// DepositAndRevert is a paid mutator transaction binding the contract method 0x1cf34dcd.
//
// Solidity: function depositAndRevert(address zrc20, uint256 amount, address target, bytes message, (address,uint64,bytes) revertContext) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactorSession) DepositAndRevert(zrc20 common.Address, amount *big.Int, target common.Address, message []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.DepositAndRevert(&_IGatewayZEVM.TransactOpts, zrc20, amount, target, message, revertContext)
}
...
func (_IGatewayZEVM *IGatewayZEVMTransactor) ExecuteRevert(opts *bind.TransactOpts, zrc20 common.Address, amount *big.Int, target common.Address, message []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayZEVM.contract.Transact(opts, "executeRevert", zrc20, amount, target, message, revertContext)
}

// ExecuteRevert is a paid mutator transaction binding the contract method 0xa3bc5e73.
//
// Solidity: function executeRevert(address zrc20, uint256 amount, address target, bytes message, (address,uint64,bytes) revertContext) returns()
func (_IGatewayZEVM *IGatewayZEVMSession) ExecuteRevert(zrc20 common.Address, amount *big.Int, target common.Address, message []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.ExecuteRevert(&_IGatewayZEVM.TransactOpts, zrc20, amount, target, message, revertContext)
}

// ExecuteRevert is a paid mutator transaction binding the contract method 0xa3bc5e73.
//
// Solidity: function executeRevert(address zrc20, uint256 amount, address target, bytes message, (address,uint64,bytes) revertContext) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactorSession) ExecuteRevert(zrc20 common.Address, amount *big.Int, target common.Address, message []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.ExecuteRevert(&_IGatewayZEVM.TransactOpts, zrc20, amount, target, message, revertContext)
}
...
func (_IGatewayZEVM *IGatewayZEVMTransactor) WithdrawAndCall0(opts *bind.TransactOpts, receiver []byte, amount *big.Int, zrc20 common.Address, message []byte, gasLimit *big.Int, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayZEVM.contract.Transact(opts, "withdrawAndCall0", receiver, amount, zrc20, message, gasLimit, revertOptions)
}

// WithdrawAndCall0 is a paid mutator transaction binding the contract method 0x90ad3e23.
//
// Solidity: function withdrawAndCall(bytes receiver, uint256 amount, address zrc20, bytes message, uint256 gasLimit, (address,bool,address,bytes) revertOptions) returns()
func (_IGatewayZEVM *IGatewayZEVMSession) WithdrawAndCall0(receiver []byte, amount *big.Int, zrc20 common.Address, message []byte, gasLimit *big.Int, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.WithdrawAndCall0(&_IGatewayZEVM.TransactOpts, receiver, amount, zrc20, message, gasLimit, revertOptions)
}

// WithdrawAndCall0 is a paid mutator transaction binding the contract method 0x90ad3e23.
//
// Solidity: function withdrawAndCall(bytes receiver, uint256 amount, address zrc20, bytes message, uint256 gasLimit, (address,bool,address,bytes) revertOptions) returns()
func (_IGatewayZEVM *IGatewayZEVMTransactorSession) WithdrawAndCall0(receiver []byte, amount *big.Int, zrc20 common.Address, message []byte, gasLimit *big.Int, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayZEVM.Contract.WithdrawAndCall0(&_IGatewayZEVM.TransactOpts, receiver, amount, zrc20, message, gasLimit, revertOptions)
}
