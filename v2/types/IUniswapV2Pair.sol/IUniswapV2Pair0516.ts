...
export interface IUniswapV2Pair0516Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface IUniswapV2Pair0516 extends BaseContract {
  connect(runner?: ContractRunner | null): IUniswapV2Pair0516;
  waitForDeployment(): Promise<this>;

  interface: IUniswapV2Pair0516Interface;
