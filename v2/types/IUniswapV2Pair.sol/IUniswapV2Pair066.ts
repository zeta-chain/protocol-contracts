...
export interface IUniswapV2Pair066Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface IUniswapV2Pair066 extends BaseContract {
  connect(runner?: ContractRunner | null): IUniswapV2Pair066;
  waitForDeployment(): Promise<this>;

  interface: IUniswapV2Pair066Interface;
