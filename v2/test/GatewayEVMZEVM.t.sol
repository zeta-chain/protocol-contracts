    ...
    IReceiverEVMEvents
{
    ...
    function testCallReceiverEVMFromZEVM() public {
        ...
        gatewayZEVM.call(abi.encodePacked(receiverEVM), address(zrc20), message, revertOptions, 1);
    ...
    function testCallReceiverEVMFromSenderZEVM() public {
        ...
        bytes memory data = abi.encodeWithSignature(
            "call(bytes,address,bytes,(address,bool,address,bytes),uint256)",
    ...
    function testWithdrawAndCallReceiverEVMFromZEVM() public {
        ...
        vm.prank(ownerZEVM);
        gatewayZEVM.withdrawAndCall(abi.encodePacked(receiverEVM), 500_000, address(zrc20), message, revertOptions, 1);
