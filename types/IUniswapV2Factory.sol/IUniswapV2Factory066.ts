...
export interface IUniswapV2Factory066Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface IUniswapV2Factory066 extends BaseContract {
  connect(runner?: ContractRunner | null): IUniswapV2Factory066;
  waitForDeployment(): Promise<this>;

  interface: IUniswapV2Factory066Interface;
