...
export interface IUniswapV2Factory0516Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface IUniswapV2Factory0516 extends BaseContract {
  connect(runner?: ContractRunner | null): IUniswapV2Factory0516;
  waitForDeployment(): Promise<this>;

  interface: IUniswapV2Factory0516Interface;
