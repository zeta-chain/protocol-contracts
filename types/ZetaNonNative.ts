...
export interface ZetaNonNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ZetaNonNative extends BaseContract {
  connect(runner?: ContractRunner | null): ZetaNonNative;
  waitForDeployment(): Promise<this>;

  interface: ZetaNonNativeInterface;
