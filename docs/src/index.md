...
# contracts
  - [❱ evm](protocol/contracts/evm/README.md)
    ...
    - [❱ legacy](protocol/contracts/evm/legacy/README.md)
      ...
      - [IZetaNonNative](protocol/contracts/evm/legacy/IZetaNonNative.sol/interface.IZetaNonNative.md)
      ...
      - [ZetaNative](protocol/contracts/evm/legacy/ZetaNative.sol/contract.ZetaNative.md)
      - [ZetaNonNative](protocol/contracts/evm/legacy/ZetaNonNative.sol/contract.ZetaNonNative.md)
