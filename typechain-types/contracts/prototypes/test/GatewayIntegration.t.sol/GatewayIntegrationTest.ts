...
export interface GatewayIntegrationTestInterface extends utils.Interface {
  functions: {
...
export interface GatewayIntegrationTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GatewayIntegrationTestInterface;
