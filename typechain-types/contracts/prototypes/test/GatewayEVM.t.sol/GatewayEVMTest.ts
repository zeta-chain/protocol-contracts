...
export interface GatewayEVMTestInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "testForwardCallToReceivePayable",
    values?: undefined
  ): string;
...
export interface GatewayEVMTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GatewayEVMTestInterface;
