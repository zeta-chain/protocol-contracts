...
export interface GatewayUpgradeTestInterface extends utils.Interface {
  functions: {
...
export interface GatewayUpgradeTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GatewayUpgradeTestInterface;
