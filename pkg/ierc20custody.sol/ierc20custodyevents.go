...
// IERC20CustodyEventsBatchWithdrawnIterator is returned from FilterBatchWithdrawn and is used to iterate over the raw logs and unpacked data for BatchWithdrawn events raised by the IERC20CustodyEvents contract.
type IERC20CustodyEventsBatchWithdrawnIterator struct {
	Event *IERC20CustodyEventsBatchWithdrawn // Event containing the contract specifics and raw log
...
func (it *IERC20CustodyEventsBatchWithdrawnIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IERC20CustodyEventsBatchWithdrawn)
...
func (it *IERC20CustodyEventsBatchWithdrawnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IERC20CustodyEventsBatchWithdrawnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IERC20CustodyEventsBatchWithdrawn represents a BatchWithdrawn event raised by the IERC20CustodyEvents contract.
type IERC20CustodyEventsBatchWithdrawn struct {
...
func (_IERC20CustodyEvents *IERC20CustodyEventsFilterer) FilterBatchWithdrawn(opts *bind.FilterOpts, token []common.Address) (*IERC20CustodyEventsBatchWithdrawnIterator, error) {
	...
	logs, sub, err := _IERC20CustodyEvents.contract.FilterLogs(opts, "BatchWithdrawn", tokenRule)
	if err != nil {
		return nil, err
	}
	return &IERC20CustodyEventsBatchWithdrawnIterator{contract: _IERC20CustodyEvents.contract, event: "BatchWithdrawn", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event BatchWithdrawn(address indexed token, uint256 length, uint256 totalAmount)
func (_IERC20CustodyEvents *IERC20CustodyEventsFilterer) WatchBatchWithdrawn(opts *bind.WatchOpts, sink chan<- *IERC20CustodyEventsBatchWithdrawn, token []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IERC20CustodyEvents.contract.WatchLogs(opts, "BatchWithdrawn", tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IERC20CustodyEventsBatchWithdrawn)
				if err := _IERC20CustodyEvents.contract.UnpackLog(event, "BatchWithdrawn", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BatchWithdrawn(address indexed token, uint256 length, uint256 totalAmount)
func (_IERC20CustodyEvents *IERC20CustodyEventsFilterer) ParseBatchWithdrawn(log types.Log) (*IERC20CustodyEventsBatchWithdrawn, error) {
	event := new(IERC20CustodyEventsBatchWithdrawn)
	if err := _IERC20CustodyEvents.contract.UnpackLog(event, "BatchWithdrawn", log); err != nil {
		return nil, err
	}
