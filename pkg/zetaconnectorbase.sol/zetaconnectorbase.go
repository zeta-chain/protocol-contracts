...
func (_ZetaConnectorBase *ZetaConnectorBaseTransactor) Deposit(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _ZetaConnectorBase.contract.Transact(opts, "deposit", amount)
}

// Deposit is a paid mutator transaction binding the contract method 0xb6b55f25.
//
// Solidity: function deposit(uint256 amount) returns()
func (_ZetaConnectorBase *ZetaConnectorBaseSession) Deposit(amount *big.Int) (*types.Transaction, error) {
	return _ZetaConnectorBase.Contract.Deposit(&_ZetaConnectorBase.TransactOpts, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0xb6b55f25.
//
// Solidity: function deposit(uint256 amount) returns()
func (_ZetaConnectorBase *ZetaConnectorBaseTransactorSession) Deposit(amount *big.Int) (*types.Transaction, error) {
	return _ZetaConnectorBase.Contract.Deposit(&_ZetaConnectorBase.TransactOpts, amount)
}
