...
// GetZRC20AddressByForeignAsset is a free data retrieval call binding the contract method 0x8b5555e8.
//
// Solidity: function getZRC20AddressByForeignAsset(uint256 originChainId, string originAddress) view returns(address)
func (_ICoreRegistry *ICoreRegistryCaller) GetZRC20AddressByForeignAsset(opts *bind.CallOpts, originChainId *big.Int, originAddress string) (common.Address, error) {
	var out []interface{}
...
//
// Solidity: function getZRC20AddressByForeignAsset(uint256 originChainId, string originAddress) view returns(address)
func (_ICoreRegistry *ICoreRegistrySession) GetZRC20AddressByForeignAsset(originChainId *big.Int, originAddress string) (common.Address, error) {
...
//
// Solidity: function getZRC20AddressByForeignAsset(uint256 originChainId, string originAddress) view returns(address)
func (_ICoreRegistry *ICoreRegistryCallerSession) GetZRC20AddressByForeignAsset(originChainId *big.Int, originAddress string) (common.Address, error) {
	return _ICoreRegistry.Contract.GetZRC20AddressByForeignAsset(&_ICoreRegistry.CallOpts, originChainId, originAddress)
}

// GetZRC20TokenInfo is a free data retrieval call binding the contract method 0xe9d6c5ba.
//
// Solidity: function getZRC20TokenInfo(address address_) view returns(bool active, string symbol, uint256 originChainId, string originAddress, string coinType, uint8 decimals)
func (_ICoreRegistry *ICoreRegistryCaller) GetZRC20TokenInfo(opts *bind.CallOpts, address_ common.Address) (struct {
	...
	outstruct.OriginAddress = *abi.ConvertType(out[3], new(string)).(*string)
...
// ChainActivation is a paid mutator transaction binding the contract method 0x4452670e.
//
// Solidity: function chainActivation(uint256 chainId, bytes registry, bool activation) returns()
func (_ICoreRegistry *ICoreRegistryTransactor) ChainActivation(opts *bind.TransactOpts, chainId *big.Int, registry []byte, activation bool) (*types.Transaction, error) {
	return _ICoreRegistry.contract.Transact(opts, "chainActivation", chainId, registry, activation)
}

// ChainActivation is a paid mutator transaction binding the contract method 0x4452670e.
//
// Solidity: function chainActivation(uint256 chainId, bytes registry, bool activation) returns()
func (_ICoreRegistry *ICoreRegistrySession) ChainActivation(chainId *big.Int, registry []byte, activation bool) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.ChainActivation(&_ICoreRegistry.TransactOpts, chainId, registry, activation)
}

// ChainActivation is a paid mutator transaction binding the contract method 0x4452670e.
//
// Solidity: function chainActivation(uint256 chainId, bytes registry, bool activation) returns()
func (_ICoreRegistry *ICoreRegistryTransactorSession) ChainActivation(chainId *big.Int, registry []byte, activation bool) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.ChainActivation(&_ICoreRegistry.TransactOpts, chainId, registry, activation)
}

// RegisterContract is a paid mutator transaction binding the contract method 0x7fda8d46.
//
// Solidity: function registerContract(uint256 chainId, address address_, string contractType, string addressString) returns()
func (_ICoreRegistry *ICoreRegistryTransactor) RegisterContract(opts *bind.TransactOpts, chainId *big.Int, address_ common.Address, contractType string, addressString string) (*types.Transaction, error) {
	return _ICoreRegistry.contract.Transact(opts, "registerContract", chainId, address_, contractType, addressString)
}

// RegisterContract is a paid mutator transaction binding the contract method 0x7fda8d46.
//
// Solidity: function registerContract(uint256 chainId, address address_, string contractType, string addressString) returns()
func (_ICoreRegistry *ICoreRegistrySession) RegisterContract(chainId *big.Int, address_ common.Address, contractType string, addressString string) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.RegisterContract(&_ICoreRegistry.TransactOpts, chainId, address_, contractType, addressString)
}

// RegisterContract is a paid mutator transaction binding the contract method 0x7fda8d46.
//
// Solidity: function registerContract(uint256 chainId, address address_, string contractType, string addressString) returns()
func (_ICoreRegistry *ICoreRegistryTransactorSession) RegisterContract(chainId *big.Int, address_ common.Address, contractType string, addressString string) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.RegisterContract(&_ICoreRegistry.TransactOpts, chainId, address_, contractType, addressString)
}

// RegisterZRC20Token is a paid mutator transaction binding the contract method 0x3314beec.
//
// Solidity: function registerZRC20Token(address address_, string symbol, uint256 originChainId, string originAddress, string coinType, uint8 decimals) returns()
func (_ICoreRegistry *ICoreRegistryTransactor) RegisterZRC20Token(opts *bind.TransactOpts, address_ common.Address, symbol string, originChainId *big.Int, originAddress string, coinType string, decimals uint8) (*types.Transaction, error) {
...
//
// Solidity: function registerZRC20Token(address address_, string symbol, uint256 originChainId, string originAddress, string coinType, uint8 decimals) returns()
func (_ICoreRegistry *ICoreRegistrySession) RegisterZRC20Token(address_ common.Address, symbol string, originChainId *big.Int, originAddress string, coinType string, decimals uint8) (*types.Transaction, error) {
...
//
// Solidity: function registerZRC20Token(address address_, string symbol, uint256 originChainId, string originAddress, string coinType, uint8 decimals) returns()
func (_ICoreRegistry *ICoreRegistryTransactorSession) RegisterZRC20Token(address_ common.Address, symbol string, originChainId *big.Int, originAddress string, coinType string, decimals uint8) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.RegisterZRC20Token(&_ICoreRegistry.TransactOpts, address_, symbol, originChainId, originAddress, coinType, decimals)
}
...
func (_ICoreRegistry *ICoreRegistryTransactor) UpdateZRC20Token(opts *bind.TransactOpts, address_ common.Address, active bool) (*types.Transaction, error) {
	return _ICoreRegistry.contract.Transact(opts, "updateZRC20Token", address_, active)
}

// UpdateZRC20Token is a paid mutator transaction binding the contract method 0xc0b03871.
//
// Solidity: function updateZRC20Token(address address_, bool active) returns()
func (_ICoreRegistry *ICoreRegistrySession) UpdateZRC20Token(address_ common.Address, active bool) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.UpdateZRC20Token(&_ICoreRegistry.TransactOpts, address_, active)
}

// UpdateZRC20Token is a paid mutator transaction binding the contract method 0xc0b03871.
//
// Solidity: function updateZRC20Token(address address_, bool active) returns()
func (_ICoreRegistry *ICoreRegistryTransactorSession) UpdateZRC20Token(address_ common.Address, active bool) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.UpdateZRC20Token(&_ICoreRegistry.TransactOpts, address_, active)
}
...
// ICoreRegistryNewChainMetadataIterator is returned from FilterNewChainMetadata and is used to iterate over the raw logs and unpacked data for NewChainMetadata events raised by the ICoreRegistry contract.
type ICoreRegistryNewChainMetadataIterator struct {
	Event *ICoreRegistryNewChainMetadata // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ICoreRegistryNewChainMetadataIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ICoreRegistryNewChainMetadata)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ICoreRegistryNewChainMetadataIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ICoreRegistryNewChainMetadataIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ICoreRegistryNewChainMetadata represents a NewChainMetadata event raised by the ICoreRegistry contract.
type ICoreRegistryNewChainMetadata struct {
	ChainId *big.Int
	Key     string
	Value   []byte
	Raw     types.Log // Blockchain specific contextual infos
...
func (_ICoreRegistry *ICoreRegistryFilterer) FilterNewChainMetadata(opts *bind.FilterOpts, chainId []*big.Int) (*ICoreRegistryNewChainMetadataIterator, error) {
	...
	logs, sub, err := _ICoreRegistry.contract.FilterLogs(opts, "NewChainMetadata", chainIdRule)
	if err != nil {
		return nil, err
	}
	return &ICoreRegistryNewChainMetadataIterator{contract: _ICoreRegistry.contract, event: "NewChainMetadata", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NewChainMetadata(uint256 indexed chainId, string key, bytes value)
func (_ICoreRegistry *ICoreRegistryFilterer) WatchNewChainMetadata(opts *bind.WatchOpts, sink chan<- *ICoreRegistryNewChainMetadata, chainId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ICoreRegistry.contract.WatchLogs(opts, "NewChainMetadata", chainIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ICoreRegistryNewChainMetadata)
				if err := _ICoreRegistry.contract.UnpackLog(event, "NewChainMetadata", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NewChainMetadata(uint256 indexed chainId, string key, bytes value)
func (_ICoreRegistry *ICoreRegistryFilterer) ParseNewChainMetadata(log types.Log) (*ICoreRegistryNewChainMetadata, error) {
	event := new(ICoreRegistryNewChainMetadata)
	if err := _ICoreRegistry.contract.UnpackLog(event, "NewChainMetadata", log); err != nil {
		return nil, err
	}
...
// ICoreRegistryNewContractConfigurationIterator is returned from FilterNewContractConfiguration and is used to iterate over the raw logs and unpacked data for NewContractConfiguration events raised by the ICoreRegistry contract.
type ICoreRegistryNewContractConfigurationIterator struct {
	Event *ICoreRegistryNewContractConfiguration // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ICoreRegistryNewContractConfigurationIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ICoreRegistryNewContractConfiguration)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ICoreRegistryNewContractConfigurationIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ICoreRegistryNewContractConfigurationIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ICoreRegistryNewContractConfiguration represents a NewContractConfiguration event raised by the ICoreRegistry contract.
type ICoreRegistryNewContractConfiguration struct {
	ChainId      *big.Int
	ContractType string
	Key          string
	Value        []byte
...
func (_ICoreRegistry *ICoreRegistryFilterer) FilterNewContractConfiguration(opts *bind.FilterOpts, chainId []*big.Int) (*ICoreRegistryNewContractConfigurationIterator, error) {
	...
	logs, sub, err := _ICoreRegistry.contract.FilterLogs(opts, "NewContractConfiguration", chainIdRule)
	if err != nil {
		return nil, err
	}
	return &ICoreRegistryNewContractConfigurationIterator{contract: _ICoreRegistry.contract, event: "NewContractConfiguration", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NewContractConfiguration(uint256 indexed chainId, string contractType, string key, bytes value)
func (_ICoreRegistry *ICoreRegistryFilterer) WatchNewContractConfiguration(opts *bind.WatchOpts, sink chan<- *ICoreRegistryNewContractConfiguration, chainId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ICoreRegistry.contract.WatchLogs(opts, "NewContractConfiguration", chainIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ICoreRegistryNewContractConfiguration)
				if err := _ICoreRegistry.contract.UnpackLog(event, "NewContractConfiguration", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NewContractConfiguration(uint256 indexed chainId, string contractType, string key, bytes value)
func (_ICoreRegistry *ICoreRegistryFilterer) ParseNewContractConfiguration(log types.Log) (*ICoreRegistryNewContractConfiguration, error) {
	event := new(ICoreRegistryNewContractConfiguration)
	if err := _ICoreRegistry.contract.UnpackLog(event, "NewContractConfiguration", log); err != nil {
		return nil, err
	}
...
// ICoreRegistryUpdatedRegistryManagerIterator is returned from FilterUpdatedRegistryManager and is used to iterate over the raw logs and unpacked data for UpdatedRegistryManager events raised by the ICoreRegistry contract.
type ICoreRegistryUpdatedRegistryManagerIterator struct {
	Event *ICoreRegistryUpdatedRegistryManager // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ICoreRegistryUpdatedRegistryManagerIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ICoreRegistryUpdatedRegistryManager)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ICoreRegistryUpdatedRegistryManagerIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ICoreRegistryUpdatedRegistryManagerIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ICoreRegistryUpdatedRegistryManager represents a UpdatedRegistryManager event raised by the ICoreRegistry contract.
type ICoreRegistryUpdatedRegistryManager struct {
	OldRegistryManager common.Address
	NewRegistryManager common.Address
	Raw                types.Log // Blockchain specific contextual infos
}

// FilterUpdatedRegistryManager is a free log retrieval operation binding the contract event 0x03355a9d296aae664ae41e386edcac639cb2259da19c02698340a951e8acc700.
//
// Solidity: event UpdatedRegistryManager(address oldRegistryManager, address newRegistryManager)
func (_ICoreRegistry *ICoreRegistryFilterer) FilterUpdatedRegistryManager(opts *bind.FilterOpts) (*ICoreRegistryUpdatedRegistryManagerIterator, error) {

	logs, sub, err := _ICoreRegistry.contract.FilterLogs(opts, "UpdatedRegistryManager")
	if err != nil {
		return nil, err
	}
	return &ICoreRegistryUpdatedRegistryManagerIterator{contract: _ICoreRegistry.contract, event: "UpdatedRegistryManager", logs: logs, sub: sub}, nil
}

// WatchUpdatedRegistryManager is a free log subscription operation binding the contract event 0x03355a9d296aae664ae41e386edcac639cb2259da19c02698340a951e8acc700.
//
// Solidity: event UpdatedRegistryManager(address oldRegistryManager, address newRegistryManager)
func (_ICoreRegistry *ICoreRegistryFilterer) WatchUpdatedRegistryManager(opts *bind.WatchOpts, sink chan<- *ICoreRegistryUpdatedRegistryManager) (event.Subscription, error) {

	logs, sub, err := _ICoreRegistry.contract.WatchLogs(opts, "UpdatedRegistryManager")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ICoreRegistryUpdatedRegistryManager)
				if err := _ICoreRegistry.contract.UnpackLog(event, "UpdatedRegistryManager", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseUpdatedRegistryManager is a log parse operation binding the contract event 0x03355a9d296aae664ae41e386edcac639cb2259da19c02698340a951e8acc700.
//
// Solidity: event UpdatedRegistryManager(address oldRegistryManager, address newRegistryManager)
func (_ICoreRegistry *ICoreRegistryFilterer) ParseUpdatedRegistryManager(log types.Log) (*ICoreRegistryUpdatedRegistryManager, error) {
	event := new(ICoreRegistryUpdatedRegistryManager)
	if err := _ICoreRegistry.contract.UnpackLog(event, "UpdatedRegistryManager", log); err != nil {
		return nil, err
	}
...
func (_ICoreRegistry *ICoreRegistryFilterer) FilterZRC20TokenRegistered(opts *bind.FilterOpts, originAddress []string, address_ []common.Address) (*ICoreRegistryZRC20TokenRegisteredIterator, error) {
...
//
// Solidity: event ZRC20TokenRegistered(string indexed originAddress, address indexed address_, uint8 decimals, uint256 originChainId, string symbol)
func (_ICoreRegistry *ICoreRegistryFilterer) WatchZRC20TokenRegistered(opts *bind.WatchOpts, sink chan<- *ICoreRegistryZRC20TokenRegistered, originAddress []string, address_ []common.Address) (event.Subscription, error) {
