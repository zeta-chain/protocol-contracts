...
// ChangeChainStatus is a paid mutator transaction binding the contract method 0x01b46c4d.
//
// Solidity: function changeChainStatus(uint256 chainId, bytes registry, bool activation) returns()
func (_ICoreRegistry *ICoreRegistryTransactor) ChangeChainStatus(opts *bind.TransactOpts, chainId *big.Int, registry []byte, activation bool) (*types.Transaction, error) {
	return _ICoreRegistry.contract.Transact(opts, "changeChainStatus", chainId, registry, activation)
}

// ChangeChainStatus is a paid mutator transaction binding the contract method 0x01b46c4d.
//
// Solidity: function changeChainStatus(uint256 chainId, bytes registry, bool activation) returns()
func (_ICoreRegistry *ICoreRegistrySession) ChangeChainStatus(chainId *big.Int, registry []byte, activation bool) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.ChangeChainStatus(&_ICoreRegistry.TransactOpts, chainId, registry, activation)
}

// ChangeChainStatus is a paid mutator transaction binding the contract method 0x01b46c4d.
//
// Solidity: function changeChainStatus(uint256 chainId, bytes registry, bool activation) returns()
func (_ICoreRegistry *ICoreRegistryTransactorSession) ChangeChainStatus(chainId *big.Int, registry []byte, activation bool) (*types.Transaction, error) {
	return _ICoreRegistry.Contract.ChangeChainStatus(&_ICoreRegistry.TransactOpts, chainId, registry, activation)
}
