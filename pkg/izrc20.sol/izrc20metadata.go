...
func (_IZRC20Metadata *IZRC20MetadataCaller) SYSTEMCONTRACTADDRESS(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _IZRC20Metadata.contract.Call(opts, &out, "SYSTEM_CONTRACT_ADDRESS")
...
//
// Solidity: function SYSTEM_CONTRACT_ADDRESS() view returns(address)
func (_IZRC20Metadata *IZRC20MetadataSession) SYSTEMCONTRACTADDRESS() (common.Address, error) {
	return _IZRC20Metadata.Contract.SYSTEMCONTRACTADDRESS(&_IZRC20Metadata.CallOpts)
}

// SYSTEMCONTRACTADDRESS is a free data retrieval call binding the contract method 0xf2441b32.
//
// Solidity: function SYSTEM_CONTRACT_ADDRESS() view returns(address)
func (_IZRC20Metadata *IZRC20MetadataCallerSession) SYSTEMCONTRACTADDRESS() (common.Address, error) {
	return _IZRC20Metadata.Contract.SYSTEMCONTRACTADDRESS(&_IZRC20Metadata.CallOpts)
}
