...
func (_IZRC20 *IZRC20Caller) SYSTEMCONTRACTADDRESS(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _IZRC20.contract.Call(opts, &out, "SYSTEM_CONTRACT_ADDRESS")
...
//
// Solidity: function SYSTEM_CONTRACT_ADDRESS() view returns(address)
func (_IZRC20 *IZRC20Session) SYSTEMCONTRACTADDRESS() (common.Address, error) {
	return _IZRC20.Contract.SYSTEMCONTRACTADDRESS(&_IZRC20.CallOpts)
}

// SYSTEMCONTRACTADDRESS is a free data retrieval call binding the contract method 0xf2441b32.
//
// Solidity: function SYSTEM_CONTRACT_ADDRESS() view returns(address)
func (_IZRC20 *IZRC20CallerSession) SYSTEMCONTRACTADDRESS() (common.Address, error) {
	return _IZRC20.Contract.SYSTEMCONTRACTADDRESS(&_IZRC20.CallOpts)
}
