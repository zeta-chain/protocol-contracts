...
var SystemContractErrorsMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"error\",\"name\":\"CallerIsNotFungibleModule\",\"inputs\":[]},{\"type\":\"error\",\"name\":\"CantBeIdenticalAddresses\",\"inputs\":[]},{\"type\":\"error\",\"name\":\"CantBeZeroAddress\",\"inputs\":[]},{\"type\":\"error\",\"name\":\"InvalidTarget\",\"inputs\":[]},{\"type\":\"error\",\"name\":\"ZeroAddress\",\"inputs\":[]}]",
}

// SystemContractErrorsABI is the input ABI used to generate the binding from.
// Deprecated: Use SystemContractErrorsMetaData.ABI instead.
...
// SystemContractErrorsSession is an auto generated Go binding around an Ethereum contract,
...
// SystemContractErrorsCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// SystemContractErrorsTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewSystemContractErrors(address common.Address, backend bind.ContractBackend) (*SystemContractErrors, error) {
	contract, err := bindSystemContractErrors(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &SystemContractErrors{SystemContractErrorsCaller: SystemContractErrorsCaller{contract: contract}, SystemContractErrorsTransactor: SystemContractErrorsTransactor{contract: contract}, SystemContractErrorsFilterer: SystemContractErrorsFilterer{contract: contract}}, nil
}
...
func NewSystemContractErrorsCaller(address common.Address, caller bind.ContractCaller) (*SystemContractErrorsCaller, error) {
	contract, err := bindSystemContractErrors(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &SystemContractErrorsCaller{contract: contract}, nil
}
...
func NewSystemContractErrorsTransactor(address common.Address, transactor bind.ContractTransactor) (*SystemContractErrorsTransactor, error) {
	contract, err := bindSystemContractErrors(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &SystemContractErrorsTransactor{contract: contract}, nil
}
...
func NewSystemContractErrorsFilterer(address common.Address, filterer bind.ContractFilterer) (*SystemContractErrorsFilterer, error) {
	contract, err := bindSystemContractErrors(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &SystemContractErrorsFilterer{contract: contract}, nil
}

// bindSystemContractErrors binds a generic wrapper to an already deployed contract.
func bindSystemContractErrors(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := SystemContractErrorsMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
func (_SystemContractErrors *SystemContractErrorsRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _SystemContractErrors.Contract.SystemContractErrorsCaller.contract.Call(opts, result, method, params...)
}
...
func (_SystemContractErrors *SystemContractErrorsRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _SystemContractErrors.Contract.SystemContractErrorsTransactor.contract.Transfer(opts)
}
...
func (_SystemContractErrors *SystemContractErrorsRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _SystemContractErrors.Contract.SystemContractErrorsTransactor.contract.Transact(opts, method, params...)
}
...
func (_SystemContractErrors *SystemContractErrorsCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _SystemContractErrors.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SystemContractErrors *SystemContractErrorsTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _SystemContractErrors.Contract.contract.Transfer(opts)
}
...
func (_SystemContractErrors *SystemContractErrorsTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _SystemContractErrors.Contract.contract.Transact(opts, method, params...)
}
