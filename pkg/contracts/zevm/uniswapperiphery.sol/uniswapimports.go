...
var UniswapImportsMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea2646970667358221220291c8a5b5fa81338f6eedd0a9b33e226da83e828449ba685880e3dc446a90e6464736f6c63430006060033",
}
...
func bindUniswapImports(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(UniswapImportsABI))
	if err != nil {
		return nil, err
	}
