...
// SetGatewayContractAddress is a paid mutator transaction binding the contract method 0xaff01572.
//
// Solidity: function setGatewayContractAddress(address gateway) returns()
func (_IZRC20 *IZRC20Transactor) SetGatewayContractAddress(opts *bind.TransactOpts, gateway common.Address) (*types.Transaction, error) {
	return _IZRC20.contract.Transact(opts, "setGatewayContractAddress", gateway)
}

// SetGatewayContractAddress is a paid mutator transaction binding the contract method 0xaff01572.
//
// Solidity: function setGatewayContractAddress(address gateway) returns()
func (_IZRC20 *IZRC20Session) SetGatewayContractAddress(gateway common.Address) (*types.Transaction, error) {
	return _IZRC20.Contract.SetGatewayContractAddress(&_IZRC20.TransactOpts, gateway)
}

// SetGatewayContractAddress is a paid mutator transaction binding the contract method 0xaff01572.
//
// Solidity: function setGatewayContractAddress(address gateway) returns()
func (_IZRC20 *IZRC20TransactorSession) SetGatewayContractAddress(gateway common.Address) (*types.Transaction, error) {
	return _IZRC20.Contract.SetGatewayContractAddress(&_IZRC20.TransactOpts, gateway)
}
