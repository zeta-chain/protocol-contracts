...
func (_GatewayUpgradeTest *GatewayUpgradeTestTransactor) Initialize(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _GatewayUpgradeTest.contract.Transact(opts, "initialize")
}

// Initialize is a paid mutator transaction binding the contract method 0x8129fc1c.
//
// Solidity: function initialize() returns()
func (_GatewayUpgradeTest *GatewayUpgradeTestSession) Initialize() (*types.Transaction, error) {
	return _GatewayUpgradeTest.Contract.Initialize(&_GatewayUpgradeTest.TransactOpts)
}

// Initialize is a paid mutator transaction binding the contract method 0x8129fc1c.
//
// Solidity: function initialize() returns()
func (_GatewayUpgradeTest *GatewayUpgradeTestTransactorSession) Initialize() (*types.Transaction, error) {
	return _GatewayUpgradeTest.Contract.Initialize(&_GatewayUpgradeTest.TransactOpts)
}
...
// GatewayUpgradeTestExecutedWithERC20V2Iterator is returned from FilterExecutedWithERC20V2 and is used to iterate over the raw logs and unpacked data for ExecutedWithERC20V2 events raised by the GatewayUpgradeTest contract.
type GatewayUpgradeTestExecutedWithERC20V2Iterator struct {
	Event *GatewayUpgradeTestExecutedWithERC20V2 // Event containing the contract specifics and raw log
...
func (it *GatewayUpgradeTestExecutedWithERC20V2Iterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GatewayUpgradeTestExecutedWithERC20V2)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *GatewayUpgradeTestExecutedWithERC20V2Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GatewayUpgradeTestExecutedWithERC20V2Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// GatewayUpgradeTestExecutedWithERC20V2 represents a ExecutedWithERC20V2 event raised by the GatewayUpgradeTest contract.
type GatewayUpgradeTestExecutedWithERC20V2 struct {
...
func (_GatewayUpgradeTest *GatewayUpgradeTestFilterer) FilterExecutedWithERC20V2(opts *bind.FilterOpts, token []common.Address, to []common.Address) (*GatewayUpgradeTestExecutedWithERC20V2Iterator, error) {
	...
	logs, sub, err := _GatewayUpgradeTest.contract.FilterLogs(opts, "ExecutedWithERC20V2", tokenRule, toRule)
	if err != nil {
		return nil, err
	}
	return &GatewayUpgradeTestExecutedWithERC20V2Iterator{contract: _GatewayUpgradeTest.contract, event: "ExecutedWithERC20V2", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ExecutedWithERC20V2(address indexed token, address indexed to, uint256 amount, bytes data)
func (_GatewayUpgradeTest *GatewayUpgradeTestFilterer) WatchExecutedWithERC20V2(opts *bind.WatchOpts, sink chan<- *GatewayUpgradeTestExecutedWithERC20V2, token []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _GatewayUpgradeTest.contract.WatchLogs(opts, "ExecutedWithERC20V2", tokenRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(GatewayUpgradeTestExecutedWithERC20V2)
				if err := _GatewayUpgradeTest.contract.UnpackLog(event, "ExecutedWithERC20V2", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ExecutedWithERC20V2(address indexed token, address indexed to, uint256 amount, bytes data)
func (_GatewayUpgradeTest *GatewayUpgradeTestFilterer) ParseExecutedWithERC20V2(log types.Log) (*GatewayUpgradeTestExecutedWithERC20V2, error) {
	event := new(GatewayUpgradeTestExecutedWithERC20V2)
	if err := _GatewayUpgradeTest.contract.UnpackLog(event, "ExecutedWithERC20V2", log); err != nil {
		return nil, err
	}
