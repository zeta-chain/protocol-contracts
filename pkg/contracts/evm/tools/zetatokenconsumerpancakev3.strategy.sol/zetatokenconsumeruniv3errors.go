...
// Deprecated: Use ZetaTokenConsumerUniV3ErrorsMetaData.ABI instead.
...
// ZetaTokenConsumerUniV3ErrorsSession is an auto generated Go binding around an Ethereum contract,
...
// ZetaTokenConsumerUniV3ErrorsCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// ZetaTokenConsumerUniV3ErrorsTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewZetaTokenConsumerUniV3Errors(address common.Address, backend bind.ContractBackend) (*ZetaTokenConsumerUniV3Errors, error) {
	contract, err := bindZetaTokenConsumerUniV3Errors(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ZetaTokenConsumerUniV3Errors{ZetaTokenConsumerUniV3ErrorsCaller: ZetaTokenConsumerUniV3ErrorsCaller{contract: contract}, ZetaTokenConsumerUniV3ErrorsTransactor: ZetaTokenConsumerUniV3ErrorsTransactor{contract: contract}, ZetaTokenConsumerUniV3ErrorsFilterer: ZetaTokenConsumerUniV3ErrorsFilterer{contract: contract}}, nil
}
...
func NewZetaTokenConsumerUniV3ErrorsCaller(address common.Address, caller bind.ContractCaller) (*ZetaTokenConsumerUniV3ErrorsCaller, error) {
	contract, err := bindZetaTokenConsumerUniV3Errors(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ZetaTokenConsumerUniV3ErrorsCaller{contract: contract}, nil
}
...
func NewZetaTokenConsumerUniV3ErrorsTransactor(address common.Address, transactor bind.ContractTransactor) (*ZetaTokenConsumerUniV3ErrorsTransactor, error) {
	contract, err := bindZetaTokenConsumerUniV3Errors(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ZetaTokenConsumerUniV3ErrorsTransactor{contract: contract}, nil
}
...
func NewZetaTokenConsumerUniV3ErrorsFilterer(address common.Address, filterer bind.ContractFilterer) (*ZetaTokenConsumerUniV3ErrorsFilterer, error) {
	contract, err := bindZetaTokenConsumerUniV3Errors(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ZetaTokenConsumerUniV3ErrorsFilterer{contract: contract}, nil
}

// bindZetaTokenConsumerUniV3Errors binds a generic wrapper to an already deployed contract.
func bindZetaTokenConsumerUniV3Errors(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ZetaTokenConsumerUniV3ErrorsABI))
	if err != nil {
		return nil, err
	}
...
func (_ZetaTokenConsumerUniV3Errors *ZetaTokenConsumerUniV3ErrorsRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ZetaTokenConsumerUniV3Errors.Contract.ZetaTokenConsumerUniV3ErrorsCaller.contract.Call(opts, result, method, params...)
}
...
func (_ZetaTokenConsumerUniV3Errors *ZetaTokenConsumerUniV3ErrorsRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ZetaTokenConsumerUniV3Errors.Contract.ZetaTokenConsumerUniV3ErrorsTransactor.contract.Transfer(opts)
}
...
func (_ZetaTokenConsumerUniV3Errors *ZetaTokenConsumerUniV3ErrorsRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ZetaTokenConsumerUniV3Errors.Contract.ZetaTokenConsumerUniV3ErrorsTransactor.contract.Transact(opts, method, params...)
}
...
func (_ZetaTokenConsumerUniV3Errors *ZetaTokenConsumerUniV3ErrorsCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ZetaTokenConsumerUniV3Errors.Contract.contract.Call(opts, result, method, params...)
}
...
func (_ZetaTokenConsumerUniV3Errors *ZetaTokenConsumerUniV3ErrorsTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ZetaTokenConsumerUniV3Errors.Contract.contract.Transfer(opts)
}
...
func (_ZetaTokenConsumerUniV3Errors *ZetaTokenConsumerUniV3ErrorsTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ZetaTokenConsumerUniV3Errors.Contract.contract.Transact(opts, method, params...)
}
