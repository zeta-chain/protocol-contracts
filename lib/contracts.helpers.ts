...
export const deployZetaConnectorBase = async ({
  args,
}: {
  args: Parameters<ZetaConnectorBaseFactory["deploy"]>;
}) => {
  const Factory = (await ethers.getContractFactory(
    "ZetaConnectorBase"
  )) as ZetaConnectorBaseFactory;

  const zetaConnectorContract = (await Factory.deploy(
    ...args
  )) as ZetaConnectorBase;
...
export const deployZetaConnectorEth = async ({
  args,
}: {
  args: Parameters<ZetaConnectorEthFactory["deploy"]>;
}) => {
  const Factory = (await ethers.getContractFactory(
    "ZetaConnectorEth"
  )) as ZetaConnectorEthFactory;
...
export const deployZetaConnectorNonEth = async ({
  ...
  const Factory = (await ethers.getContractFactory(
    "ZetaConnectorNonEth"
  )) as ZetaConnectorNonEthFactory;

  const zetaConnectorContract = (await Factory.deploy(
    ...args
  )) as ZetaConnectorNonEth;
...
export const deployImmutableCreate2Factory = async () => {
  const Factory = (await ethers.getContractFactory(
    "ImmutableCreate2Factory"
  )) as ImmutableCreate2Factory__factory;

  const ImmutableCreate2FactoryContract =
    (await Factory.deploy()) as ImmutableCreate2Factory;
...
export const getZetaConnectorEth = async (
  params: GetContractParams<ZetaConnectorEthFactory>
) =>
...
export const getZetaConnectorNonEth = async (
  params: GetContractParams<ZetaConnectorNonEthFactory>
) =>
...
export const getZetaFactoryNonEth = async (
  params: GetContractParams<ZetaNonEthFactory>
) =>
...
export const getZetaFactoryEth = async (
  params: GetContractParams<ZetaEthFactory>
) =>
...
export const getZetaTokenConsumerUniV2Strategy = async (
  params: GetContractParams<ZetaTokenConsumerUniV2Factory>
) =>
...
export const getZetaTokenConsumerUniV3Strategy = async (
  params: GetContractParams<ZetaTokenConsumerUniV3Factory>
) =>
