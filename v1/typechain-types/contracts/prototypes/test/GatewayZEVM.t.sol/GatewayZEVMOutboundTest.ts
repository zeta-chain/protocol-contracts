...
export interface GatewayZEVMOutboundTestInterface extends utils.Interface {
  functions: {
    ...
    "testDepositAndCallZContract()": FunctionFragment;
    "testExecuteZContract()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSenders"
      | "testDeposit"
      | "testDepositAndCallZContract"
      | "testExecuteZContract"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDepositAndCallZContract",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testExecuteZContract",
    values?: undefined
  ): string;
...
export interface GatewayZEVMOutboundTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GatewayZEVMOutboundTestInterface;
  ...
  callStatic: {
    ...
    testDepositAndCallZContract(overrides?: CallOverrides): Promise<void>;

    testExecuteZContract(overrides?: CallOverrides): Promise<void>;
  };
